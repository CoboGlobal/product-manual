...
1. [Sign up for an account in Cobo Account](/accounts/sign-up). You can use email, Google Account, or Web3 wallet for signup.
2. [Log in to Cobo Account](/accounts/log-in) with the account you just created. You will then be asked to set up multi-factor authentication with Google Authenticator.
...
Cobo Portal combines all four wallet technologies in one platform. To learn how to choose the right wallet type for you, see [Introduction to Cobo Portal](/portal/introduction#an-all-in-one-wallet-platform).
...
- To learn how to move assets within, into, and out of the four wallet types, see [Transfer](/portal/transfers/introduction).
