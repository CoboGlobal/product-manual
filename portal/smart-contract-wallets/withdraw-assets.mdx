...
4. Enter your **To** address. Note that the delegate can only withdraw the authorized tokens to an address listed in transfer whitelists on Cobo Argus. For more information, please refer to [**Add transfer whitelists**](/portal/smart-contract-wallets/transfer-whitelists).
...
3. Select the **token** type for withdrawal and enter your **To** address. Note that the delegate can only withdraw the authorized tokens to an address listed in transfer whitelists on Cobo Argus. For more information, please refer to [**Add transfer whitelists**](/portal/smart-contract-wallets/transfer-whitelists).
