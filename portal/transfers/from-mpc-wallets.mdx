...
To make a transfer from MPC Wallets (Organization-Controlled Wallets), click <img src="/images/transfers/transfer-button.png" className="icon"></img> in the main menu on the left hand side.
