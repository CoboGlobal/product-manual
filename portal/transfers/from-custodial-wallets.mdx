...
To make a transfer from Custodial Wallets (Asset Wallets), click <img src="/images/transfers/transfer-button.svg" className="icon"></img> in the main menu on the left hand side.
