...
7. (Optional) Add category or description to your transaction. For details, see [Add category and description](/portal/transfers/add-category).
8. Click **Submit**.
...
Note: For the list of exchanges supported by Cobo Portal, please refer to [Supported exchanges](/portal/exchange-wallets/supported-exchanges).
