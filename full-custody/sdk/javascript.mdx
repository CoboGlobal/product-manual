...
title: "JavaScript"
icon: "js"
description: "If you’re working with JavaScript, the official [cobo-js-api](https://github.com/CoboGlobal/cobo-js-api) package is the easiest way to use."
---
...
```
yarn build
yarn test -env=sandbox/develop/prod -secretKey=<yourApiSecret>
```
...
const { LocalSigner } = require("cobo-custody");
const { SANDBOX, DEVELOP, PROD } = require("cobo-custody");
