...
---
#### Request
<ParamField body="coin" type="String" >The coin to query staking information for.</ParamField> 
<ParamField body="language" type="String" >The language to parse product information in.</ParamField> 
