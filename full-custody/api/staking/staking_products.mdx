...
<ParamField body="coin" type="String" >The coin to filter staking products by.</ParamField>
<ParamField body="language" type="String" >The language to use for staking product names and descriptions.</ParamField>
