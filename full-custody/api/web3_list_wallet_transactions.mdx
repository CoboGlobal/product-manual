...
---
#### Request
<ParamField query="address" type="String" required>Wallet address to retrieve transactions for.</ParamField>
<ParamField query="max_id" type="Int" >Maximum transaction ID to retrieve.</ParamField>
<ParamField query="min_id" type="Int" >Minimum transaction ID to retrieve.</ParamField>
<ParamField query="limit" type="Int" >Maximum number of transactions to retrieve.</ParamField>
<ParamField query="chain_code" type="String" >Chain code of the wallet.</ParamField>
