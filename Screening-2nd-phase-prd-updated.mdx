...
| Sanctioned | Text | 否 | 显示 Screening Address 是否命中制裁扫描，若交易使用风险扫描，制裁信息需要从 Reason Categories 字段判断(制裁 Label：uk\_ofsi\_sanctioned, ofac, jp\_sanctioned, jp\_mof\_sanctioned, uk\_sanctioned) |
