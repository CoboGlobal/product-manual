...
<ResponseField name="result" type="object[]">
  <Expandable title="object">
    ...
    <ResponseField name="created_time" type="Long">Transaction creation time(milliseconds)</ResponseField>
    <ResponseField name="last_time" type="Long">Transaction success/failure time(milliseconds)</ResponseField>
