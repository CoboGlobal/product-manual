...
description: "This endpoint retrieves transaction details by transaction ID. It requires authentication and takes a single query parameter 'txid' which is the transaction ID to retrieve details for. The response is a JSON object containing transaction details."
---
