...
<Tip> FAQ：[How do I query the minimum deposit amount for a specific coin?](/get-started/faq/waas#how-do-i-query-the-minimum-deposit-amount-for-a-specific-coin)</Tip>
