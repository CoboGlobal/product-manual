...
<Tip> FAQ：[How to query the transaction details of a batch withdrawal request?](/get-started/faq/waas#how-to-query-the-transaction-details-of-a-batch-withdrawal-request)</Tip>
