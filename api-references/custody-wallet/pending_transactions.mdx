...
<Tip> FAQ：[How do I query the details of a pending transaction?](/get-started/faq/waas#how-do-i-query-the-details-of-a-pending-transaction)</Tip>
...
<ResponseField name="result" type="object[]">
  <Expandable title="object">
    ...
    <ResponseField name="status" type="enum(pending)">Transaction status</ResponseField>
