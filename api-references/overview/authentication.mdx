...
<CardGroup cols={3}>
  <Card title="Java" icon="java" color="#ea5a0c" href="../sdks/waas/java"></Card>
  <Card title="PHP" icon="php" color="#0285c7" href="../sdks/waas/php"></Card>
  <Card title="Python" icon="python" color="#16a34a" href="../sdks/waas/python"></Card>
  <Card title="JavaScript" icon="js" color="#dc2626" href="../sdks/waas/javascript"></Card>
  <Card title="Go" icon="golang" color="#dc2626" href="../sdks/waas/go"></Card>
</CardGroup>
