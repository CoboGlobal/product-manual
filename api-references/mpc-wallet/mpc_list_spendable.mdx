...
<Note>This API is only intended for MPC wallets and does not support MPC web3 wallets.</Note>

#### Request
<ParamField query="coin" type="String" required>The asset coin symbol (e.g. BTC, ETH).</ParamField>
