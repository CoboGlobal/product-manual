...
<font color="red">(make an illustration)</font>

### Initiate the key generation process
The key share generation process is initiated by the admins on Cobo Portal, and the keys would be categorized into one of the three groups: Master Key Group, Signing Key Group, and Backup Key Group. We will use the Master Key Group to illustrate the process. <font color="red">(Link to content discussing Master Key Group, Signing Key Group, and Backup Key Group in case the reader wants to learn more about them)</font>
...
<font color="refd">(add screenshot here)</font>
