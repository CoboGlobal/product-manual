...
### How to verify whether a withdrawal address is legitimate?
    <Expandable title="Answer">
        <ResponseField >You can use the [GET /v1/custody/is_valid_address/](/api-references/custody-wallet/is_valid_address) endpoint to query whether a withdrawal address under a Custodial Wallet is legitimate.
