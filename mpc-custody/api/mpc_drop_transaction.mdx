...
description: "This endpoint is accessible via a POST request to https://api.custody.cobo.com/CustodyMPCApi/drop_transaction/. It accepts parameters 'cobo_id' and 'request_id' as required fields, and 'fee', 'gas_price', 'gas_limit', and 'fee_amount' as optional fields. The endpoint returns a JSON response containing information about the transaction request."
---
...
#### Response
<ResponseField name="cobo_id" type="String" >Unique ID for the new transaction</ResponseField>
