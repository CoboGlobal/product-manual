...
The above process can be achieved using [Cobo Safe SDKs](https://www.cobo.com/developers/smart-contract-wallet/sdk/js). The following uses Cobo Safe SDKs in Javascript as an example.
