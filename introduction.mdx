...
<CardGroup cols={2}>
   <Card title="Wallet as a Service" icon="warehouse" href="waas" color="#ea5a0c">
   RESTful APIs to Build Your Crypto Applications.
  </Card>
   <Card title="Custodial Wallet" icon="warehouse" href="custodial-wallet" color="#ea5a0c">
    HSM/SGX based centralized custody solution.
  </Card>
   <Card title="MPC Wallet" icon="people-group" href="mpc-wallet" color="#ea5a0c">
