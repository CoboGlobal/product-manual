...
<CardGroup cols={2}>
   ...
   <Card title="MPC Custody" icon="people-group" href="mpc-wallet" color="#ea5a0c">
   Multi-Party-Computation (MPC) based Threshold Signature Scheme (TSS) to eliminate single point of failure.
  </Card>
   <Card title="Smart Contract Custody" icon="file-contract" href="smart-contract-wallet" color="#0285c7">
