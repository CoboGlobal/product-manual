...
### Set up Cobo Guard
   1. Log in to [Cobo Accounts](https://accounts.cobo.com/), the account management platform for Cobo products.
   2. On the left sidebar, click **MFA Management**. Navigate to the **Cobo Guard** section and click **Set up**.
   3. Follow the instructions on the screen to install Cobo Guard on your iOS device, and then scan the QR code to link your account with your Cobo Guard.
