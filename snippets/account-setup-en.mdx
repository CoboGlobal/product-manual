...
As an example, you could assign the Admin or Manager role to two members, then set up a governance policy requiring approval from at least two members with either of these roles before deleting a member, as illustrated in the screenshot below.
