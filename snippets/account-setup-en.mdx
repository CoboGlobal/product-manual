...
### Set up Cobo Guard
   1. Log in to Cobo Portal.
      * Direct registration for a free trial grants you immediate access to the Production Environment. There is no need to switch to the development environment; you can conduct your trial and self-service upgrades directly within the production environment.
