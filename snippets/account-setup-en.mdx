...
Use the activation link from our sales team to activate the Cobo Portal account provisioned for you.
...
### Invite members
   ...
   Upon receiving the invitation, new members should accept it, activate their accounts, and set up Portal Mobile as described in the previous sections.
