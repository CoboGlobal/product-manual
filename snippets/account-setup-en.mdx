...
### Invite team members
   ...
   4. Enter the team member's email address and name, and then select appropriate user roles. To learn security best practices for assigning user roles, see [Introduction to user roles and permissions](/en/portal/organization/roles-and-permissions).
