...
| :---- | :---- | :---- | :---- | :---- | :---- |
| P0 | 风险扫描 | 扫描触发机制 (风险扫描与制裁扫描) | [Lucas Chang](mailto:lucas.chang@cobo.com) | [Zhaoyu Yang](mailto:zhaoyu.yang@cobo.com) | [Yixue Chang](mailto:ychang@cobo.com) |
| P0 | 风险扫描 | 扫描结果 \- 主页面 扫描结果 \- 风险详情 | [Lucas Chang](mailto:lucas.chang@cobo.com) | [Zhaoyu Yang](mailto:zhaoyu.yang@cobo.com)[Zhengbo Liu](mailto:zliu@cobo.com) | [Yixue Chang](mailto:ychang@cobo.com) |
| P0 | 风险处置策略 | 策略面板 建立策略 编辑策略 删除策略 策略操作纪录 | [Lucas Chang](mailto:lucas.chang@cobo.com) | [Zhaoyu Yang](mailto:zhaoyu.yang@cobo.com)[Zhengbo Liu](mailto:zliu@cobo.com) | [Yixue Chang](mailto:ychang@cobo.com) |
| P0 | 风险处置动作 | 批准 批准并告警 拒绝 解除冻结 | [Lucas Chang](mailto:lucas.chang@cobo.com) | [Zhaoyu Yang](mailto:zhaoyu.yang@cobo.com)[Zhengbo Liu](mailto:zliu@cobo.com) | [Yixue Chang](mailto:ychang@cobo.com) |
| P0 | 审核状态流程 | 待扫描已扫描已批准 已批准 (资金解冻)已拒绝 (资金冻结) 未支持 | [Lucas Chang](mailto:lucas.chang@cobo.com) | [Zhaoyu Yang](mailto:zhaoyu.yang@cobo.com)[Zhengbo Liu](mailto:zliu@cobo.com) | [Yixue Chang](mailto:ychang@cobo.com) |
| P1 | 风险处置动作 | 人工审核 人工审核 \- 审核通过 人工审核 \- 审核拒绝 退回 | [Lucas Chang](mailto:lucas.chang@cobo.com) | [Zhaoyu Yang](mailto:zhaoyu.yang@cobo.com)[Zhengbo Liu](mailto:zliu@cobo.com) | [Yixue Chang](mailto:ychang@cobo.com) |
| P1 | 审核状态流程 | 待审核 已拒绝 (资金退回) | [Lucas Chang](mailto:lucas.chang@cobo.com) | [Zhaoyu Yang](mailto:zhaoyu.yang@cobo.com)[Zhengbo Liu](mailto:zliu@cobo.com) | [Yixue Chang](mailto:ychang@cobo.com) |
...
6. Filter 新增栏位  
   ...
   * Review Status  
   * Fund Status  
   * Created Time (原字段命名为 Transfer Time)  
   * Updated Time
...
| Sanctioned | Text | 否 | 显示 Screening Address 是否命中制裁扫描，若交易使用风险扫描，制裁信息需要从 Reason Catories 字段判断 |
...
用户可以在策略面板管理风险处置策略，包含建立、编辑和删除。系统若未筛选到符合的策略，将自动批准交易  
![][image12]
...
| 未支持 (Not Supported) | AML 供应商尚未支持交易所使用的链，交易跳过 AML 审核往下流转 |
