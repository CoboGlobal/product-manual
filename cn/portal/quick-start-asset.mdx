...
使用销售团队提供的激活链接激活已为您开通的 Cobo Portal 账户。按邮件中的邀请链接完成激活：
1. 设置密码
2. 输入邮箱验证码
3. 加入团队

激活后，您可通过 [https://portal.dev.cobo.com/login](https://portal.dev.cobo.com/login) 登录 Cobo Portal 开发环境。
...
更多信息请参阅 [Portal Mobile](/cn/portal-mobile/introduction#主要功能)。
