...
- Delegates can either be Cobo Custodial Wallets or Cobo MPC Wallets. Custodial Wallet private keys are managed by Cobo, while MPC Wallet private keys are managed through distributed MPC key shares.
