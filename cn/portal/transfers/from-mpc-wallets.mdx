...
4. **签名**：Cobo 根据在线状态等条件选择一个可用的[签名人](/cn/portal/mpc-wallets/ocw/holder-group-main-group#create-a-main-group)来签署交易。请通知您的移动端签名人，或查看服务端签名人状态，详情请参见本文**通知移动端签名人或查看服务端签名人状态**一节。
