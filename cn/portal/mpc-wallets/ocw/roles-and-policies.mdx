...
To learn more about configuring user roles and permissions, see [Introduction to Organization](/cn/portal/organization/introduction).
...
To learn how to configure the transaction policies, see [Overview](/cn/portal/risk-controls/tx-policies-overview).