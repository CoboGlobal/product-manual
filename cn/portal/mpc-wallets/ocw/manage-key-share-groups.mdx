...
Follow the steps below to navigate to the **Key Share Group Management** page:
...
3. Select your vault.
4. Click <img src="/cn/images/mpc-wallet/manage-key-share-group.svg" className="icon"></img> on the upper right hand corner.
