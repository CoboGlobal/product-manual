...
Cobo Portal 支持自动和手动私钥分片验证。使用此功能前，请确保您的 TSS Node 已升级至 0.1.0 或更高版本，或 Cobo Guard 已升级至 2.0.3 或更高版本。
...
- 组类型：包括主控组、签名组和恢复组。
6. 在想要验证的私钥分片右侧，点击 <img src="/cn/images/mpc-wallet/recurring.svg" className="icon" alt="设置定期私钥分片验证" />。在弹出的窗口中填写以下信息：
