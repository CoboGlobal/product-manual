...
<table class="six-columns">
  ...
  <tr>
    ...
    <td>
      API 签名人是一个服务器节点，用于自动通过 [TSS Node 软件包](/cn/portal/mpc-wallets/ocw/network-environments)签署交易。其 TSS Node ID 通过 Cobo 提供的 TSS 软件包生成，且必须在设置钱包之前生成。有关进一步说明，请参见 <a href="/cn/portal/mpc-wallets/ocw/network-environments">TSS 节点技术设置</a>。
    </td>
  </tr>
  <tr>
    <td>前提步骤</td>
