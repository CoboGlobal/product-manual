...
<table class="six-columns">
  ...
  <tr>
    ...
    <td>
      服务端签名人是一个服务器节点，用于自动通过 TSS Node 软件包签署交易。其 TSS Node ID 通过 Cobo 提供的 TSS Node 软件包生成，且必须在设置钱包之前生成。有关进一步说明，请参见[服务端签名人介绍](https://www.cobo.com/developers/v2/guides/mpc-wallets/server-co-signer/tss-node-overview)。
    </td>
  </tr>
  <tr>
    <td>前提步骤</td>
    ...
    <td>
      您选择的私钥分片持有者需要向您提供他们生成的 TSS Node ID。有关进一步说明，请参见[服务端签名人介绍](https://www.cobo.com/developers/v2/guides/mpc-wallets/server-co-signer/tss-node-overview)。
    </td>
  </tr>
</table>
...
5. 签名组创建过程与主控组创建过程相同。详细说明请参见[创建主控组](/cn/portal/mpc-wallets/ocw/holder-group-main-group)。
