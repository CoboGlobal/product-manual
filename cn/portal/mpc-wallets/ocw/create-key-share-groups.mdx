...
创建 Vault 后，需要创建持有者组。持有者组分为 3 种：主控组、签名组和恢复组。
...
<table class="six-columns">
  ...
  <tr>
    ...
    <td>
      API 签名人是一个服务器节点，用于自动签署通过 [WaaS 2.0 API](https://www.cobo.com/developers/v2/guides/overview/introduction) 发起的交易。其 TSS Node ID 通过 Cobo 提供的 TSS 节点软件包生成，且必须在设置钱包之前生成。有关进一步说明，请参见 <a href="/cn/portal/mpc-wallets/ocw/network-environments">TSS 节点技术设置</a>。
    </td>
  </tr>
  <tr>
    <td>前提步骤</td>
    ...
    <td>
      您选择的私钥分片持有者需要向您提供他们生成的 TSS Node ID。有关进一步说明，请参见 <a href="/cn/portal/mpc-wallets/ocw/network-environments">TSS 节点技术设置</a>。
    </td>
  </tr>
</table>
