...
<table class="six-columns">
  ...
  <tr>
    ...
    <td>
      服务端签名人是一个服务器节点，用于自动通过 TSS Node 软件包签署交易。其 TSS Node ID 通过 Cobo 提供的 TSS 软件包生成，且必须在设置钱包之前生成。有关进一步说明，请参见[服务端签名人介绍](https://www.cobo.com/developers/v2/guides/mpc-wallets/server-co-signer/tss-node-overview)。
    </td>
  </tr>
  <tr>
    <td>前提步骤</td>
