...
您可以初始化 TSS 节点并创建数据库文件。如果数据库文件已经存在，则执行将失败。有关更多信息，请参阅 [TSS 节点初始化](/cn/portal/mpc-wallets/ocw/tss-node-deployment#tss-node-initialization)。
...
cobo-tss-node 将开始运行。有关更多信息，请参阅 [TSS 节点启动](/cn/portal/mpc-wallets/ocw/tss-node-deployment#tss-node-startup)。
