...
### 步骤7：在 Cobo Portal 查看 Safe{Wallet} 交易历史

1. 登录 [Cobo Portal](https://portal.cobo.com/login)。
2. 在左侧主菜单中点击 <img src="/cn/images/common/wallets_icon.svg" className="icon"/> > **交易历史**。
3. 点击**过滤**并选择 **Safe{Wallet} 交易**以查看您的 Safe{Wallet} 交易历史。
