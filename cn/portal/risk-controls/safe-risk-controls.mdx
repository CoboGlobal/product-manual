...
### 步骤1：在 Cobo Portal 上创建 MPC 或 Web3 钱包地址
...
### 步骤2：在 Cobo Portal 上创建 Safe{Wallet} 消息签名规则
...
如果您想要查看所有 Safe{Wallet} 交易而不是某条规则相关的交易记录，在左侧主菜单中点击 <img src="/cn/images/common/wallets_icon.svg" className="icon"/> > **交易历史**，然后点击**过滤**并勾选 **Safe{Wallet} 交易消息**。
