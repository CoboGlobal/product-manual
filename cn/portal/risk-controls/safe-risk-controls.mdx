...
按前述，风控规则配置完成后，Cobo Portal 会自动开始监控 [Safe Transaction Service](https://docs.safe.global/core-api/transaction-service-overview)，查到对应 Safe&#123;Wallet&#125; 的待签名交易时，则发起签名请求，开始相应的风控流程。审批员将在其 [Portal Mobile App](/cn/guard/introduction) 中收到通知，审核该签名请求。
