...
<img src="/cn/images/exchange-wallet/22.png" className="screenshot_full_screen"/>
To assign new roles to team members or view their current roles, click **Organization** > **Members**.

<img src="/cn/images/exchange-wallet/23.png" className="screenshot_full_screen"/>

For details, see [Organization](/cn/portal/organization/introduction).
...
For details, see [Off-chain transaction policies](/cn/portal/risk-controls/off-chain-tx-set-transfer).