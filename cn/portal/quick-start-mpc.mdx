...
## 设置费用管理（可选）
在开发环境中，Payment 团队可以启用 Fee Station 管理适用的 Gas 费用。Payment 团队详情请参阅[Fee Station 简介](/cn/portal/fee-station/introduction)。
...
充值主链币：如需支付链上手续费，请确保钱包中有足够对应链的主链币。Payment 团队可在 [Fee Station](/cn/portal/fee-station/introduction) 中充值 Gas Token 或美元稳定币，用于适用的 Gas 费用处理。
...
在提币前，请确保钱包中有足够主链币用于支付链上手续费。Payment 团队使用 [Fee Station](/cn/portal/fee-station/introduction) 处理适用的 Gas 费用。
