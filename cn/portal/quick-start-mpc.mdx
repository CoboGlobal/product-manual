...
新账户和新组织无法自行注册。如需开通，请[联系 Cobo 销售团队](https://www.cobo.com/book-demo/?utm_source=product-manual&utm_medium=product&utm_campaign=contact-sales)。开通完成后，请登录销售团队为您的组织配置的环境；如需在生产环境中正式使用，请参考[正式使用](/cn/portal/quick-start-guide-mpc)文档。
...
## 设置费用中心（可选）
如果您希望在开发环境中使用 Cobo 的美元稳定币代付链上交易手续费功能，或集中管理主链币以支付 Gas，可以启用费用中心。它相当于一个团队共享的费用账户，可根据配置策略为链上交易自动代付 Gas，并统一结算各类平台费用。详情请参阅[费用中心简介](/cn/portal/billing-center/introduction)。
...
充值主链币：如需支付链上手续费，请确保钱包中有足够对应链的主链币。您可以在 [费用中心](/cn/portal/billing-center/introduction) 预充值对应链的主链币，或充值美元稳定币用以代付链上手续费。
...
在提币前，请确保钱包中有足够主链币用于支付链上手续费，或者已启用 [费用中心](/cn/portal/billing-center/introduction) 代付功能。
