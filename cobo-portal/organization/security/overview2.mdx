...
Governance policies decide under what approval rule an operation will be approved or rejected. Approval rules include auto rejection, auto approval, subject to approval quorum, and subject to customized workflow. Governance policies can be categorized into 5 categories: Members, Organizations, Wallets, Developers, and User Roles.
...
You can get a clear overview of the governance policies by clicking **Organization** > **Security** > **Governance Policies**. Then, click either the Members, User Roles, Organization, Wallets, or Developers tab to view the associated governance policies and their status.
