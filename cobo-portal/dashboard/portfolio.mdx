...
- **Assets**: Assets are aggregated across blockchains.
- **Wallets**: Total asset value in each wallet category.
    - Exchange Wallets
    - Custodial Wallets
        - Asset Wallet
        - Web3 Wallet
    ...
    - Smart Contract Wallets
        - Safe&#123;Wallet&#125;
- **Networks**: Total asset value across exchanges and blockchains.
