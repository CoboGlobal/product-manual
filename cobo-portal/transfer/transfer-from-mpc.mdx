---
title: "Transfer from MPC Wallet (Organization-Controlled Wallet)"
sidebarTitle: "Transfer from MPC Wallet (Organization-Controlled Wallet)"
---
...
3. To find your wallet, select it from the drop-down menu or search by the address, name (i.e., vault name or wallet name) or label. MPC Wallet (Organization-Controlled Wallet) created via both Cobo Portal Web and API will be listed.
