...
3. To find your exchange account, select it from the drop-down menu or search by the wallet name. All exchange accounts linked through Cobo Portal Web and API will be displayed.
   ...
   - Transfers between different accounts within the same Sub Account or Main Account are considered  "internal transfers" and are not subject to fees by the exchanges.
...
_Note: For the list of exchanges supported by Cobo Portal, please refer to this [product manual](/cobo-portal/wallets/exchange-wallet/supported-exchanges)._
