...
For more details, please refer to the [<u>**Organization** user manual</u>](https://cobo-6.mintlify.app/cobo-portal/organization/introduction).
...
To learn how to configure the transaction policies, refer to [<u>**Transaction Policies** user manual</u>](https://cobo-6.mintlify.app/cobo-portal/transaction-policies/introduction).
