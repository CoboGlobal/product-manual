...
For more details, please refer to the [<u>**Organization** user manual</u>](cobo-portal/organization/introduction).
...
To view the transaction policies associated with your wallet, click on **View Transaction Policies** in the respective wallet.

{/* <img src="/images/exchange-wallet/user-roles-tx-policies-3.png"/> */}

To learn how to configure the transaction policies, refer to [<u>**Transaction Policies** user manual</u>](/cobo-portal/transaction-policies/introduction).
