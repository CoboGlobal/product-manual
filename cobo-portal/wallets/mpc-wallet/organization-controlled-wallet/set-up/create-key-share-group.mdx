...
After you've chosen a co-signer type and set up the prerequisites, follow the instructions below to create a Main Group. **Note:** Only the users who have been assigned [the Operator user role in the organization](/cobo-portal/organization/security/overview1) can create a Main Group.
...
After you've chosen a co-signer type and set up the prerequisites, follow the instructions below to create a Signing Group. **Note:** Only the users who have been assigned [the Operator user role in the organization](/cobo-portal/organization/security/overview1) can create a Signing Group.
...
After you've chosen a co-signer type and set up the prerequisites, follow the instructions below to create a Recovery Group. **Note:** Only the users who have been assigned [the Operator user role in the organization](/cobo-portal/organization/security/overview1) can create a Recovery Group.
