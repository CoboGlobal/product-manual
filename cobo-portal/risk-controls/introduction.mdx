...
1. [Transaction policies](/cobo-portal/risk-controls/transaction-policies/introduction).: You can select from three different types of off-chain transaction policies. Additionally, you can implement customized approval rules, such as auto approval and auto rejection, to streamline workflow processes.
