...
in [https://api.develop.cobo.com/v1/test/](https://api.develop.cobo.com/v1/test/).
...
| Method | URL                                           | Nonce         |
| ------ | --------------------------------------------- | ------------- |
| POST   | https://api.develop.cobo.com/v1/custody/test/ | 1537498830736 |
...
Callback. (NOTICE they're different in Develop&Production environment)
