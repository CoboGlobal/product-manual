...
[Develop environment](https://home.develop.cobo.com/). You need to first
create an account at Cobo Custody Develop environment, then set up the
...
Develop environment. You've followed [the tutorial](quickstart) to
generate your API-KEY and API-SECRET. And you've set your API-KEY in Cobo
Custody web interface.

<Warning>API Playground only supports the Develop environment.
