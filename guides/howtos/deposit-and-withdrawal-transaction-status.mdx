---
title: "Deposit and Withdrawal Transaction Status"
sidebarTitle: "Deposit and Withdrawal Process"
"og:title": "Deposit and Withdrawal Transaction Status"
"og:description": " Discover the withdrawal and deposit processes for both Custodial Wallets and MPC Wallets."
---

For digital asset custodians, crypto transactions can be broadly categorized into two types: withdrawals and deposits.
A withdrawal transaction is initiated by the client directly on the Cobo platform.
...
### Withdrawal process for Custodial Wallets and MPC Wallets:

<img src="/images/custodial-wallet-withdrawal-process.png" />

Notes for withdrawal transactions initiated from Custodial Wallets:
