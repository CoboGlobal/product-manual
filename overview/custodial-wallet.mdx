...
via RESTful APIs. Our [Wallet-as-a-Service (WaaS) ](waas-introduction)allows clients
...
than 70 chains. Cobo Custodial Wallet handles token sweeping, reducing the effort
