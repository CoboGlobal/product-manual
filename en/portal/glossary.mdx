...
### TSS Node
A server node with the TSS Node package installed. It functions as a server co-signer that stores the key shares of your MPC Wallets and automatically sign transactions initiated by your MPC Wallets.
