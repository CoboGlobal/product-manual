...
### Server co-signers
A server co-signer is a server node that stores the key shares of your MPC Wallets. The server co-signer utilizes the TSS Node package to automatically sign transactions initiated by your MPC Wallets.
