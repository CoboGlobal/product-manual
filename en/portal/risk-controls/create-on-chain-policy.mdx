...
12. Click **Next** to review the policy you have configured.
13. If you want to make edits to the policy, click **Cancel**.
14. A multi-sig confirmation from Safe&#123;Wallet&#125; signers is required. Click **Submit** to initiate the multi-sig transaction. Alternatively, click **Add to Queue** and later navigate to **Smart Contract Wallets** > **On-Chain Transaction Policies** > **Queue** to batch-submit all multi-sig confirmation requests in the queue.
