...
<img src="/images/risk-controls/create_policy.png" className="screenshot_full_screen"/>
...
- **Amounts**: You can specify the maximum amount for the spender to spend per transaction.
...
- **Transfer Amounts**: You can set the maximum transaction amount.
...
- **Approval Quorum**: Transactions meeting the above conditions will require a specified number of approvals to proceed. Please click **+ Set Approvers** to add one or more team members as approvers. You can choose by role types or member names. Then, set the approval quorum.
