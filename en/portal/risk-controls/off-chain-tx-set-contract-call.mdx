...
6. Select an **Applicable Network** that is applicable to the policy you are about to create. For MPC Wallets, the supported networks are **All EVM Networks** and **SOL**.
