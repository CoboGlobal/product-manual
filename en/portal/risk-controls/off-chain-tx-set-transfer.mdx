...
**Initiator**: The policy will be triggered only if the transaction is initiated by designated parties. You can choose between **API Initiators** or **Web Initiators**.
- **API Initiators**: You can specify whether any team members, or only specific members, are allowed to initiate transactions via API.
...
- **Conditions**: You can define either the maximum transaction amount applied per transaction or within a specified time window, denominated in hours.
