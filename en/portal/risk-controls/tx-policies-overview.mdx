...
lang: "en"
description: "Learn about transaction policies in Cobo Portal, automating transaction handling."
---
...
Transaction policies are managed by Cobo Portal's backend system. They offer:
...
Transaction policies include the following types:
...
| Message signing | Control transaction signing | • Initiators<br/>• Message types |
