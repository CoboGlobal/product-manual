...
sidebarTitle: "Manage Emergency Policy"
lang: "en"
...
<Note>Prerequisite: By default, permission to manage the emergency policy is restricted to Admins. You can also configure custom user roles to include this permission.</Note>
...
<Note>While an emergency policy is active, you can still create new custom policies, but they will have lower priority than the emergency policy.</Note>
