...
### Step 7: View Safe{Wallet} transaction history on Cobo Portal

1. Log into [Cobo Portal](https://portal.cobo.com/login).
2. Click <img src="/en/images/common/wallets_icon.svg" className="icon"/> > **Transaction History** in the main menu on the left-hand side.
3. Click **Filter** and select **Safe{Wallet} Transactions** to view your Safe{Wallet} transaction history.
