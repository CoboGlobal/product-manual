...
<Info>After the policy is configured, Cobo Portal automatically starts monitoring the Safe Transaction Service to check for pending transactions that require signatures.</Info>
