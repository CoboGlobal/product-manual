...
- Marks high-risk factors with red exclamation marks that reveal risk details when clicked, for example:
   - For the **To** field: 
   ...
   For high-risk factors, you need to review the details and confirm you understand the risk before you approve the message.
