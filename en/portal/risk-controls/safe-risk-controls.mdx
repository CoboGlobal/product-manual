...
<Note>Prerequisite: Ensure that you have created your multi-signature wallet on the [Safe&#123;Wallet&#125; official website](https://app.safe.global) before proceeding with the following steps.</Note>
