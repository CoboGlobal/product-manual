...
As mentioned previously, after the message signing policy is configured, Cobo Portal automatically monitors the [Safe Transaction Service](https://docs.safe.global/core-api/transaction-service-overview). When a pending transaction is found for the corresponding Safe&#123;Wallet&#125;, Cobo Portal initiates a signature request and starts the risk control process. Approvers will receive a notification in their [Portal Mobile App](/en/guard/introduction) to review the request.
