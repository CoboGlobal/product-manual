...
To learn about how to make and track Cobo Loop transfers, refer to [Transfer from Custodial Wallets (Asset Wallets)](/en/portal/transfers/from-asset-wallets).
