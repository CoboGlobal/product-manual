...
You can customize gas fees. Payment organizations use [Fee Station](/en/portal/fee-station/introduction) for eligible gas-fee handling. If Fee Station does not cover the operation, maintain the required native gas-token balance.
