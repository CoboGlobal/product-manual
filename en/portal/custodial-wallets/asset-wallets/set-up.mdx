...
<Note>Asset Wallets use the same address across all supported EVM chains. For existing wallets, addresses created on one EVM chain will automatically work on all other supported EVM chains.</Note>
