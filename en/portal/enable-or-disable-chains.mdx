...
To view the chains currently enabled for a specific wallet type, in the left navigation menu click **Billing Center**, then select the **Bills & Plans** tab, find the **Resource usage** for that wallet type (for example, **MPC Wallets**), and click the **Chain Management** icon in the top-right corner of the **Supported Chains** card. The **Chain Management** panel opens, listing the chains currently enabled for the selected wallet type.
