...
To view the chains currently enabled for a specific wallet type, click your profile avatar (top-right) > **Pricing Plans** > the wallet type card you want to check (for example, **MPC Wallets**) > **Supported Chains** > **Manage**. The **Chain Management** panel opens, listing the chains currently enabled for the selected wallet type.
