...
Pricing plans for Custodial Wallets and MPC Wallets include a quota on the number of chains that can be actively used. To help manage resource allocation and billing, additional chains must be manually enabled as needed.
