...
- Transaction Fee Payments:
    - Transaction fees for MPC Wallets and Asset Wallets (Web3 Wallets)
...
With a sufficient balance, Fee Station will automatically settle payments for your Cobo bills. Manual configuration is only required if you want to use Fee Station to pay transaction fees for MPC Wallets and Asset Wallets (Web3 Wallets).
...
For **MPC Wallets and Asset Wallets (Web3 Wallets) transaction fees**, Fee Station offers automatic fee settlement for transactions on both EVM and TRON chains, using the **respective fee tokens** of each chain.
