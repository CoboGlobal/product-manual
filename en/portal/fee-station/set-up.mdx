...
For **MPC transaction fees**, Fee Station offers automatic fee settlement for transactions on both EVM and TRON chains, using the **respective fee tokens** of each chain. Alternatively, clients may choose to settle MPC transaction fees using **USDT**.
