...
Currently, withdrawals from Fee Station are not supported. In the event of account closure, any remaining balance can be transferred to an address you provide.
