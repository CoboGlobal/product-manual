...
- Account reserve requirements on Solana: Some Solana accounts must maintain a minimum SOL balance to remain active on-chain. If a deposit address uses such an account, the reserved portion may be excluded from the swept amount and remain in the address.
