...
- **Organization-Controlled Wallet (OCW)**: 2-of-2 signing scheme with one key share held by the organization and the other stored within Cobo's multi-cloud infrastructure; both are required to independently authorize each transaction
