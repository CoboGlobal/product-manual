...
- Use the applicable billing tool for eligible Gas handling to prevent sweep interruptions
...
Payment organizations use Fee Station for eligible on-chain Gas and platform-fee management.

- Unified Gas management for eligible addresses and chains
- Gas fee handling for eligible transactions
- Billing-related balance management
- Fee settlement records for supported workflows
...
1. **Create an Institutional Wallet and Complete Basic Configuration**
   ...
   - Initialize the applicable fee-management tool
...
4. **Asset Distribution (Rewards / NFT)**
   ...
   - The applicable fee-management tool helps handle eligible Gas requirements

5. **Auto-Sweep**
   - Enable sweeping → Configure sweeping policy → Consolidate funds periodically or on trigger conditions
   - Eligible Gas handling and automatic RBF improve success rate
