...
- Integrate with Billing Center for automatic Gas top-up to prevent sweep interruptions
...
### 5. Billing Center (Unified On-Chain Fee Management)

Billing Center is an account for centrally managing on-chain Gas and platform fees:
...
4. **Asset Distribution (Rewards / NFT)**
   ...
   - Billing Center automatically ensures sufficient Gas

5. **Auto-Sweep**
   - Enable sweeping → Configure sweeping policy → Consolidate funds periodically or on trigger conditions
   - Billing Center tops up Gas / automatic RBF improves success rate
