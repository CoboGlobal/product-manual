...
<Note>Prerequisite: Please set up your account and complete other required steps following the [Quick start guide](/en/portal/quick-start-guide). Additionally, you need to [create](/en/portal/mpc-wallets/ocw/set-up) an MPC Wallet (Organization-Controlled).</Note>

Note: Currently, creating a Smart Contract Wallet on Cobo Portal is akin to setting up a Safe&#123;Wallet&#125; with Cobo Safe enabled.
