...
- Gas fees apply to the withdrawal part of the sweep transaction. Payment organizations use [Fee Station](/en/portal/fee-station/introduction) for eligible gas-fee handling. If Fee Station does not cover the operation, maintain the required native gas-token balance on the deposit address.
<Info>Payment organizations can refer to [How to use Fee Station](/en/portal/fee-station/set-up) for more details.</Info>
...
<Note>Gas fees apply to the withdrawal part of the sweep transaction. Payment organizations use [Fee Station](/en/portal/fee-station/introduction) for eligible gas-fee handling. If Fee Station does not cover the operation, maintain the required native gas-token balance on the deposit address.</Note>
