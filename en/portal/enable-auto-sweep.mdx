...
- Gas fees apply to the withdrawal part of the sweep transaction. It is recommended to enable [Billing Center](/en/portal/billing-center/introduction) to automatically supplement the gas fee when the deposit address balance is insufficient. Otherwise, you will need to ensure sufficient main chain coin balance at the deposit address.
<Info>For more details, refer to [How to use Billing Center](/en/portal/billing-center/introduction).</Info>
...
<Note>Gas fees apply to the withdrawal part of the sweep transaction. It is recommended to enable [Billing Center](/en/portal/billing-center/introduction) to automatically supplement the gas fee when the deposit address balance is insufficient. Otherwise, you will need to ensure sufficient main chain coin balance at the deposit address.</Note>
