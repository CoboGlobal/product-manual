...
- deposit addresses: By default, after you enable auto token sweeping, deposit addresses can only receive funds and sweep them to the designated sweep-to address. They cannot be used for withdrawals, contract calls, staking, OTC transactions, or financial product transactions, and they cannot act as delegate addresses for smart contract wallets. To use these functions, please enable deposit address transaction via **Wallet Settings** > **Auto-Sweep Settings**.
