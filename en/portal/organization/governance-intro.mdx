...
You can view and modify governance policies in Cobo Portal by clicking your user profile icon > **Organization** > **Governance Policies**. You can also switch between the **Members**, **User Roles**, **Organization**, **Wallets**, or **Developers** tabs to view the associated governance policies and their status. For more details, refer to [Edit governance policies](/en/portal/organization/governance-edit).
