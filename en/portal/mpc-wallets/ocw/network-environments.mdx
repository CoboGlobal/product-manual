...
- When the server is being installed or upgraded:
  - Able to access the apt sources of the system to install all necessary dependencies (only applicable if a SGX-ready server or an off-the-shelf server is used)
