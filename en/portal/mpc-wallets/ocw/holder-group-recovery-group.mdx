...
After you've chosen a signer type and set up the prerequisites, follow the instructions below to create a Recovery Key. **Note:** Only the users who have been assigned the Operator, Manager, Admin [user roles]((/en/portal/organization/roles-and-permissions)) in the organization can create a Recovery Key.
