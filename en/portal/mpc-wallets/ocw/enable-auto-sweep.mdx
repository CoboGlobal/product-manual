...
lang: "en"
description: "Learn how to enable auto token sweeping for MPC Wallets (Organization-Controlled Wallets) and explore the resulting updates to wallet features and transaction management."
---

This guide explains how to enable the auto token sweeping feature for an Organization-Controlled Wallet on Cobo Portal. For more details about auto token sweeping, refer to [Overview](/en/portal/mpc-wallets/ocw/auto-sweep-overview).
...
- If you use a TSS Node Callback server for risk control review, you can add the sweep-to address to the server's whitelist to automatically approve sweep transactions. For more details, refer to the sample project in [Implement auto token sweeping](https://www.cobo.com/developers/v2/guides/mpc-wallets/server-co-signer/risk-control-best-practices#auto-sweeping-implementation).
