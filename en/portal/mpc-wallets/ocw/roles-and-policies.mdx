...
To learn more about configuring user roles and permissions, see [Introduction to Organization](/en/portal/organization/introduction).
...
To learn how to configure the transaction policies, see [Overview](/en/portal/risk-controls/tx-policies-overview).