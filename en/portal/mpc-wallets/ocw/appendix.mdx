...
| callback/token_expire_minutes      | cb-token-expire      | Timeout period for callback server's JWT: Default value: 2Unit: minutes |
...
| callback/request_timeout           | cb-request-timeout   | Timeout period for HTTP request Default value: 10Unit: seconds |
...
| Type                     | 1                                       | Default value is 1.                                          |
| Curve                    | secp256k1                               | Signature algorithm that has been used.                      |
