...
lang: "en"
description: "Learn how to create Signing Groups using the Main Group for enhanced security in MPC Wallets."
---
...
Similar to creating the Main Group, you have the option to choose either mobile co-signer or server co-signer when creating the Signing Group. Make sure you understand the primary purposes and prerequisites of each co-signer type by referring to the table in [Create a Main Group](/en/portal/mpc-wallets/ocw/holder-group-main-group#signer-type) before proceeding further.
...
5. The Signing Group creation process is the same as the Main Group creation process. See [Create Main Group](/en/portal/mpc-wallets/ocw/holder-group-main-group) for detailed instructions.
