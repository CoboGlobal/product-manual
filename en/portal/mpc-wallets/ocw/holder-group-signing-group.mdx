...
Similar to creating the Main Group, you have the option to choose either mobile co-signer or Server co-signer when creating the Signing Group. Make sure you understand [the primary purposes and prerequisites of each co-signer type](#signer-type) before proceeding further.
