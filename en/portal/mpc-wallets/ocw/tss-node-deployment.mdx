...
For detailed instructions on how to add a TSS Node ID to Cobo Portal, refer to [Create a Main Group](/en/portal/mpc-wallets/ocw/create-key-share-groups#create-a-main-group).
