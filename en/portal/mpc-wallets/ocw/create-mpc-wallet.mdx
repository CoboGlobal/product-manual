...
<Note>MPC Wallets use the same address across all supported EVM chains. You only need to create it once. Existing addresses on one EVM chain will automatically work on all other supported EVM chains.
