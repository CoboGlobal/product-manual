...
## Prerequisite
Cobo Portal supports both automated and manual key share verification. To use this feature, make sure that your TSS Node is updated to version 0.1.0 or later, or your Cobo Guard is updated to version 2.0.3 or later.
