...
| ------------ | ------------ | ------------------------------------------------------------ |
| SuperLoop    | Cobo         | An off-exchange custodian and settlement network that enables trading on exchanges from [MPC Wallets](/en/portal/mpc-wallets) or [Custodial Wallets](/en/portal/custodial-wallets), while retaining full control of your funds. For more details about SuperLoop, see [Cobo SuperLoop](https://www.cobo.com/products/superloop). |
