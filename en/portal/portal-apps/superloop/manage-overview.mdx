...
- To manage an individual exchange account, click **Manage** <img src="/en/images/common/icon_advanced.svg" className="icon" alt="Gear icon"/> under **Action** for the targeted account. See [Manage an exchange account](/en/portal/portal-apps/superloop/manage-an-exchange-account).
