...
- To see the full list of supported chains by Cobo Portal, [click](https://www.cobo.com/chains) here.
    <Note>Not all supported chains are enabled by default. If you do not see a specific chain during wallet operations or transactions, follow [Add chains to your organization](/en/portal/add-chains) to add it to your organization.</Note>
