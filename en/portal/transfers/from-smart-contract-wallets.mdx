...
9. <MySnippet />
10. Click **Submit**.
11. Approve the request on your Portal Mobile. If it is a new address not found in your Address Book or any of your wallets created on Cobo Portal, you will be prompted to add the address to your Address Book.
