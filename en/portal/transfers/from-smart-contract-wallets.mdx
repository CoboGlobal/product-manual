...
4. Select a Delegate address (abbreviated as Delegate). For more information on Delegates, see [Set up on-chain transaction policies for token transfers](/en/portal/risk-controls/on-chain-tx-type).
