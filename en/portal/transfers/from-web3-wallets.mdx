...
5. Select a **To** address from your Address Book or your wallets on Cobo Portal, or manually enter an address.
    ...
    <img src="/en/images/custodial-wallet/web3/web3-wallet-cobo-loop.png" className="screenshot_full_screen"/>
...
7. Review the transaction cost. You are unable to modify or customize this fee. The fee amount varies depending on the token being transferred and will be deducted from the source address. Please ensure that the source address has sufficient balance for the fee payment.
