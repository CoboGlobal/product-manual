...
After the transaction is confirmed, the transaction will be sent to signes. The transaction will remain pending until it receives the necessary signature. 
