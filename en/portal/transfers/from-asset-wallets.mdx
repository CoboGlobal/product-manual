...
7. Review the transaction cost. You are unable to modify or customize this fee. The fee amount varies depending on the token being transferred and will be deducted from the source wallet that you selected in step 3. Please ensure that the source wallet has the required token enabled and sufficient balance for the fee payment.
8. <MySnippet />
9. Click **Submit**.
