...
<Info>  
For transfers on the TRON chain from a Custodial Wallet, Cobo offers transaction fee discounts:  
- **Without staking TRX**: Each transaction fee enjoys a 50% discount.  
- **With staking TRX**:  
  - Additional discount: Transaction fees can be reduced by up to 71%.  
  - Staking yield: Staked TRX can earn up to 30% annualized returns, further lowering the overall cost of use. 
</Info>  
...
7. Review the transaction cost. You are unable to modify or customize this fee. 
    ...
    Transaction fees consist of the following three ß:
	...
	- Withdrawal gas fee: The gas fee required by the blockchain network to process your withdrawal transaction, calculated based on the real-time on-chain gas price.
