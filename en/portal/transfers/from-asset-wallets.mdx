...
3. For **Wallet Type**, select **Asset Wallets**. For the wallet address, select from the drop-down menu or search by wallet name, address, or label. Asset Wallets created via both Cobo Portal and WaaS 2.0 API will be listed.
