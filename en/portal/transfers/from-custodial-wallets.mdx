...
3. In the drop-down menu under **From**, select **Asset Wallets** under **Custodial Wallets**.
    To find your wallet, select it from the drop-down menu or search by wallet name, address, or label. Asset Wallets created via both Cobo Portal and WaaS 2.0 API will be listed.
