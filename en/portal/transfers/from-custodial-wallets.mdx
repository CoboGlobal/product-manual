...
After making a transfer from your Custodial Wallets, you can view its transaction status in **Transaction History**. The flash icon <img src="/en/images/portal/custodial-wallets/icon_loop.svg" className="icon" alt="The flash icon" /> indicates it was executed as a Cobo Loop transfer as the following screenshot shows.
