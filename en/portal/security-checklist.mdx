...
- The same private key share holder (the same [TSS Node ID](/en/portal/glossary#tss-node)) should not hold key shares of diffrent types of keys simultaneously, such as both the Main Key and the Signing Key. If this situation occurs, please ensure that there is more than one Signing Key.
