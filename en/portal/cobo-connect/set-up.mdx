...
1. Search for Cobo Connect in the [Chrome Web Store](https://chromewebstore.google.com/). 
2. Open the Cobo Connect extension page, click **Add to Chrome.**
3. Read the information in the pop-up window and click **Add extension** if you agree to the terms.
4. Disable other wallet extensions as suggested, then click **Continue**.
5. Create and confirm the password for Cobo Connect, then click **Continue**.
6. Follow the on-screen instructions and pin the extension for easier access, then click **Continue**. 
...
3. Under **Action**, click the Cobo Connect icon <img src="/en/images/common/icon_cobo_connect.svg" className="icon" alt="Cobo Connect"></img> next to the wallet you want to import addresses from. In the pop-up window, click **Allow** to confirm connection to Cobo Portal.
