...
Congratulations on successfully setting up your MPC Wallet (Organization-Controlled Wallet) and completing token transfers! To enhance the security of your assets, read [Security checklist](/en/portal/security-checklist) and consider taking these crucial next steps:
