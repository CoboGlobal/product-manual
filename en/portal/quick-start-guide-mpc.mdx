...
This guide provides a step-by-step walkthrough for setting up and using [MPC Wallets (Organization-Controlled Wallets)](/en/portal/mpc-wallets/ocw/introduction) on Cobo Portal. You'll learn how to:
...
## What's next
Congratulations on successfully setting up your MPC Wallet (Organization-Controlled Wallet) and completing token transfers! To further enhance your wallet's security and functionality, consider implementing these next steps:
