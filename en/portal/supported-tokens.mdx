...
- After submitting your self-listing request, Cobo will conduct a review, with different handling based on assessed risk: low-risk scenarios support automatic review; medium and high-risk scenarios require manual review.
