...
<Warning>If no Callback Endpoint is configured for the API key, callback-based withdrawal double-check is not performed and withdrawal requests are approved by default.</Warning>
