...
2. Navigate to your wallet:
   - For Custodial Wallets: Click **Wallets** in the left sidebar, then select **Custodial Wallets**
   - For MPC Wallets: Click **Wallets** in the left sidebar, then select **MPC Wallets**
