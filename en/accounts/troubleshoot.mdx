...
- **Cobo Portal**: This is Cobo's digital asset wallet platform. When a user accepts an organization invitation and activates their membership, the system also provisions a Cobo Account for them.
...
When a user accepts an invitation to join a Cobo Portal organization and activates their membership for the first time, a Cobo Account is provisioned for them and MFA is set up during the process.
