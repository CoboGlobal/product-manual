...
6. On the staking details page, you can find the following updates.
   ...
   - Under **Staking Positions**, the **Position Status** is updated to **Unstaking in Progress**.
      - If the unstaking succeeds, the **Position Status** will become **Withdrawable**, and a **Withdraw** button appears under **Actions**.
      - If the unstaking fails, the **Position Status** will change back to **Active**, and the **Unstake** button appears under **Actions**.
