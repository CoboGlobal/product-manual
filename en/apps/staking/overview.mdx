...
- **Available to Stake** - The amount of assets that can be staked from the wallets in **Wallet Scopes**, which you set during app installation. You can update **Wallet Scopes** by editing [app settings](/en/portal/portal-apps/app-settings).
- **Actions** 
