...
<Tabs>
  ...
  <Tab title="ETH">
    <Note>Prerequisite 1: You have created an MPC Wallet in an Organization-Controlled Vault and deposited ETH. You have added the wallet in [**Wallet Scopes**](/en/portal/portal-apps/app-settings) accessible by Staking.</Note>
    ...
    7. In the **Staking Request Submitted** window, click **Staking Activity** to go to the staking details page.
    4. On the staking details page, new records are created for the staking transaction.
