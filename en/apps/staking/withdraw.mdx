...
<Note>Prerequisite 1: You have unstaked BTC or BTC that has naturally expired in an MPC Wallet in an Organization-Controlled Vault. The wallet has not been moved out of [**Wallet Scopes**](/en/portal/portal-apps/app-settings) accessiible by Staking.</Note>
