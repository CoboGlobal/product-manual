...
<Note>Prerequisite 1: You have unstaked BTC or BTC that has naturally expired in an MPC Wallet in an Organization-Controlled Vault or in a Web3 Wallet. The wallet has not been moved out of [**Wallet Scopes**](/en/apps/app-settings) accessible by Staking.</Note>
