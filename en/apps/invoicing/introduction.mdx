...
<img src="/en/images/portal-apps/invoicing/invoicing-in-app-store.png" className="screenshot_modal" alt="Image showing Invoicing Appears as a Cobo Portal App."/>
