...
<Note>You can select and configure your preferred AML provider in the [Screening settings](/en/apps/screening/screening-settings#aml-provider-settings).</Note>
...
<table class="table six-columns">
  ...
  <tbody>
    ...
    <tr>
      <td>Risk</td>
      <td>Risk: 
        • CipherOwl: Low/Medium/High
        • Elliptic: NA or numerical score from 0.0 to 10.0 (in 0.1 increments)
      </td>
    </tr>
    <tr>
      <td>Min USD</td>
...
<table class="table six-columns">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>CipherOwl: Risk classification from [CipherOwl](https://s.cipherowl.ai/Address-Risk-Score-1a0d90dd030f80b5904cd4aa76e15cea)<br/><br/>Elliptic: Numerical risk score with higher values indicating higher risk. For details, see [Elliptic's Risk Score documentation](https://help.elliptic.co/en/articles/2641454-interpreting-risk-scores)</td>
    </tr>
    <tr>
      <td>Amount Range</td>
...
For guidance on risk assessment and policy creation, refer to CipherOwl's [Address Risk Score](https://s.cipherowl.ai/Address-Risk-Score-1a0d90dd030f80b5904cd4aa76e15cea) documentation or consult with their compliance experts via [CipherOwl](https://www.cipherowl.com/)'s website. For Elliptic's risk scoring system, refer to their [Interpreting Risk Scores](https://help.elliptic.co/en/articles/2641454-interpreting-risk-scores) and [Configuring Your Risk Rules](https://help.elliptic.co/en/articles/8216353-configuring-your-risk-rules) documentation.
</Warning>
