...
<table class="table six-columns">
  ...
  <tbody>
    ...
    <tr>
      <td>Reject</td>
      <td>• Inbound:<br/>&nbsp;&nbsp;• Currently: Flag transactions<br/>&nbsp;&nbsp;• Coming soon: Freeze funds <br/>&nbsp;&nbsp;&nbsp;&nbsp;• *Note: If you are using the [Auto-Sweep feature of MPC Wallets](/en/portal/mpc-wallets/ocw/auto-sweep-overview), frozen funds will not be included in the sweep operation.*<br/>• Outbound: Block transaction<br/>• Risk notification is always sent</td>
    </tr>
    <tr>
...
For guidance on risk assessment and policy creation, refer to CipherOwl's [Address Risk Score](https://cipherowl.notion.site/Address-Risk-Score-1a0d90dd030f80b5904cd4aa76e15cea) documentation or consult with their compliance experts via [CipherOwl](https://www.cipherowl.com/)'s website.
</Warning>
