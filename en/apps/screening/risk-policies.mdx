...
<table class="table six-columns">
  ...
  <tbody>
    ...
    <tr>
      <td>Reject</td>
      <td>• Inbound:<br/>&nbsp;&nbsp;• Flag transactions and freeze funds <br/>&nbsp;&nbsp;&nbsp;&nbsp;• *Note: If you are using the [auto token sweeping feature of MPC Wallets](/en/portal/mpc-wallets/ocw/auto-sweep-overview), frozen funds will not be included in the sweep operation.*<br/>• Outbound: Block transaction<br/>• Risk notification is always sent</td>
    </tr>
    <tr>
