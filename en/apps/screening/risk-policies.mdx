...
<table class="table six-columns">
  ...
  <tbody>
    ...
    <tr>
      <td>Max USD</td>
      <td>Maximum transaction amount in USD (exclusive)<br/>A dash ("-") indicates no upper limit</td>
    </tr>
    <tr>
      <td>Decision</td>
      <td>Action to take when policy matches:<br/>• Approve<br/>• Approve with Alert<br/>• Reject<br/>• Manual Review (coming soon)</td>
    </tr>
    <tr>
      <td>Updated Time</td>
...
<table class="table six-columns">
  ...
  <tbody>
    ...
    <tr>
      <td>Decision</td>
      <td>• Approve<br/>• Approve with Alert<br/>• Reject<br/><i>Manual Review option coming soon</i></td>
    </tr>
    <tr>
      <td>Updated Time</td>
...
- If no policy matches, the transaction is automatically approved
</Note>
...
<table class="table six-columns">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Risk classification from Screening</td>
    </tr>
    <tr>
      <td>Amount Range</td>
      <td>• Min Amount<br/>• Max Amount</td>
      <td>Transaction value range (in USD)<br/>A dash ("-") in Max Amount indicates no upper limit</td>
    </tr>
  </tbody>
</table>
...
<table class="table six-columns">
  ...
  <tbody>
    ...
    <tr>
      <td>Reject</td>
      <td>• Inbound: Freeze funds¹<br/>• Outbound: Block transaction</td>
    </tr>
  </tbody>
</table>
...
*Manual Review option coming soon*
...
For guidance on risk assessment and policy creation, refer to CipherOwl's [Address Risk Score](https://cipherowl.notion.site/Address-Risk-Score-1a0d90dd030f80b5904cd4aa76e15cea) documentation or consult with their compliance experts via [CipherOwl](https://www.cipherowl.com/).
</Warning>
