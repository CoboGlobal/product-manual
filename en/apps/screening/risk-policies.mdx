...
<table class="table six-columns">
  ...
  <tbody>
    ...
    <tr>
      <td>Reject</td>
      <td>• Inbound:<br/>&nbsp;&nbsp;• Currently: Flag transactions<br/>&nbsp;&nbsp;• Coming soon: Freeze funds <br/>&nbsp;&nbsp;&nbsp;&nbsp;• *Note: If you are using the [auto token sweeping feature of MPC Wallets](/en/portal/auto-sweep-overview), frozen funds will not be included in the sweep operation.*<br/>• Outbound: Block transaction<br/>• Risk notification is always sent</td>
    </tr>
    <tr>
