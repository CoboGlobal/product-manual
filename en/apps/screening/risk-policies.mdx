  ...
  <table class="table six-columns">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>CipherOwl: Risk classification from [CipherOwl](https://cipherowl.notion.site/Address-Risk-Score-1a0d90dd030f80b5904cd4aa76e15cea)</td>
      </tr>
      <tr>
        <td>Amount Range</td>
  ...
  <table class="table six-columns">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Elliptic: Numerical risk score with higher values indicating higher risk (see [Elliptic's Risk Score documentation](https://help.elliptic.co/en/articles/2641454-interpreting-risk-scores))</td>
      </tr>
      <tr>
        <td>Amount Range</td>
        <td>• Min Amount<br/>• Max Amount</td>
