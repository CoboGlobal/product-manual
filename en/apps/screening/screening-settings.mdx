...
<Note>
- Elliptic requires valid API credentials to function
</Note>
...
- Refund & Isolation Screening
    ...
    Determine whether to apply AML screening to special transaction types:

    If the options are not checked, refund and isolation transactions will be automatically bypassed.
