...
- **Transaction Screening Policy:**
    ...
    Configure screening rules for transfers between wallets on Cobo Portal (internal transactions) and all other transfers (external transactions) based on amount thresholds. Transactions not meeting the amount thresholds will be bypassed automatically.
