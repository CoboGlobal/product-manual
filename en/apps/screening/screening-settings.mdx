...
| Setting | Description |
| --- | --- |
| AML Provider | Select between CipherOwl and Elliptic |
...
- **Transaction Screening Policy:**
    ...
    Configure screening rules for different transaction types based on amount thresholds.

    - **Transfers between Cobo wallets** refer to internal transactions
    - **All other transfers** refer to xternal transactions

    Transactions not meeting the amount thresholds will be bypassed automatically.
