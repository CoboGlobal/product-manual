...
<Tabs>
  ...
  <Tab title="BlockSec">
    ...
    **Key information:**
    ...
    | Field | Description |
    | --- | --- |
    | AML Provider | The vendor used for transaction screening<br/>• BlockSec |
    | Risk | The risk level returned by BlockSec<br/>• Severe<br/>• High<br/>• Medium<br/>• Low |
    | Screening Type | BlockSec's screening type<br/>• KYA (address screening)<br/>• KYT (transaction screening) |
