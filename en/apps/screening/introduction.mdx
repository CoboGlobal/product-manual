...
Screening is a [Cobo Portal App](/en/portal/portal-apps/introduction) maintained by CipherOwl. After [installing the app](/en/apps/screening/set-up), you can use it to scan all incoming and outgoing transactions. The app provides notifications and scan result viewing, showing whether any transaction addresses have been sanctioned.
