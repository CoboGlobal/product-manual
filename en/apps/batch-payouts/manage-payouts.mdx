...
3. Click the corresponding icons in the **Actions** column to perform the actions as follows:
    ...
    | Action     | Applicable Transaction Status                      | Note                 |
    | ---------- | -------------------------------------------------- | ---------------------------------------- |
    | Cancel     | Submitted<br />Pending Screening<br />Pending Approval<br />Pending Signature | This action only applies to transactions from MPC Wallets. |
    | Drop       | Broadcasting                                       | This action only applies to transactions from MPC Wallets. It does not apply to transactions on the following chains: VET, TRON, TVET, SOL, and TON.      |
    | Speed up   | Broadcasting                                       | This action only applies to transactions from MPC Wallets. It does not apply to transactions on the following chains: VET, TRON, TVET, SOL, and TON.     |
    | Resend     | Failed                                             | This action only applies to transactions from MPC Wallets in the SOL token. |
