...
Batch Payouts is a [Cobo Portal App](/en/portal/portal-apps/introduction) built by Cobo that is designed to streamline and simplify the process of making multiple transfers in one go. 
