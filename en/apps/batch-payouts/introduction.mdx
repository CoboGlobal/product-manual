...
Batch Payouts supports recipient confirmation through Cobo Guard, ensuring secure transactions. For recipients without Cobo accounts, you can send a guidance email with just one click, providing them with the necessary steps to confirm their transactions.
