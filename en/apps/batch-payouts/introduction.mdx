...
Batch Payouts supports recipient confirmation through Portal Mobile, ensuring secure transactions. Recipients must use Cobo Accounts provisioned by Cobo Sales and link Portal Mobile. If a recipient does not yet have an account, contact Sales before initiating the payout.
