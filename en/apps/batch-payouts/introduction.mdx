...
### Support for Portal Mobile Confirmation
Batch Payouts supports recipient confirmation through Portal Mobile, ensuring secure transactions. For recipients who have not created Cobo accounts or have not linked Portal Mobile, you can send a guidance email with just one click, providing them with the necessary steps.
