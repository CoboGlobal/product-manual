...
- `MANAGER_ROLE`: Manager role identifier. Addresses with this role can perform all management operations except contract upgrades and permission management, such as configuring token access controls, resuming contracts, etc.
