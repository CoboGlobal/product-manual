...
- **Compliance-enforced token standards** including CoboERC20 smart contract (ETH, BSC) and Token-2022 Program (Solana) to maintain regulatory alignment
...
3. Manage operational permissions among team members, such as token minting and contract pausing
