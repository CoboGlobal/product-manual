...
- **Burn:** Permanently remove tokens from circulation, for example, when processing investor redemptions.
  ...
  <Note>
  **Note:**
  For the CoboERC20 smart contract,
    - When you click **Mint** or **Burn**, you need to enter the token amount in readable format (for example, entering 1 = 1 token). 
    - When you click **More Actions** to access contract functions and call **mint** and **burn**, you need to enter the raw amount (for example, for a 6-decimal token, entering 1,000,000 = 1 token). 
