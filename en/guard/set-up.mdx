...
2. After setting up the PIN code, you will be prompted to choose between **Link device to your account** or **Restore existing key shares first**.

    <img src="/en/images/cobo-guard/common/restore1.png" className="screenshot_modal" alt="Options of whether to restore key shares" />

3. Choose **Link device to your account**.
