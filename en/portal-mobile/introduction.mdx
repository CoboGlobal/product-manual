...
Portal Mobile includes a built-in AI assistant. You can ask questions in natural language and get supplementary information related to your account, transactions, and approvals. In approval scenarios, the AI assistant helps you understand the background and potential risks of an approval request.
