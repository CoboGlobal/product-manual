...
Portal Mobile supports Google and email sign-in on both platforms, plus Apple sign-in on iOS. Email users can register or sign in with a one-time verification code, and can set an email password after registration. For details, see [Register and sign in to Cobo Portal Mobile](/en/portal-mobile/register-and-sign-in).
...
- **Organization selection and web setup**: Select an organization when applicable, or continue organization creation on the Cobo Portal web app.
