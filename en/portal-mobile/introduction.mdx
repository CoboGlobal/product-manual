...
![TODO: Screenshot of the Cobo Portal Mobile App home screen]()
...
![TODO: Screenshot of completing MFA verification in Portal Mobile]()
...
![TODO: Screenshot of signing a transaction in Portal Mobile]()
...
![TODO: Screenshot of approving an operation initiated by other members in Portal Mobile]()
...
Portal Mobile includes a built-in AI assistant. You can ask questions in natural language and get supplementary information related to your account, transactions, and approvals. In approval scenarios, the AI assistant helps you understand the background and potential risks of an approval request. For details, see [Cobo Portal Mobile App AI assistant](/en/portal-mobile/assistant).

<Note>Cobo AI features are currently in Beta and available only to selected users. The AI assistant provides supplementary information only; it does not replace human judgment, nor does it automatically advance approval or signing processes. For an overview of Cobo AI, refer to [Introduction to Cobo AI](/en/ai/introduction).</Note>

## Relationship with Cobo Guard

The Cobo Portal Mobile App is the **next-generation replacement** for Cobo Guard. Portal Mobile covers all of Cobo Guard's security capabilities (MFA, MPC key share management, operation approval), and additionally extends cross-platform support, asset and transaction management, multi-cloud backup, and an AI assistant.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>All Cobo Guard capabilities, plus asset and transaction management, multi-cloud backup, and an AI assistant</td>
    </tr>
    <tr>
