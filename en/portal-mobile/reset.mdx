...
<Note>**Eligibility reminder — Portal Mobile reset is for eligible new users already using Portal Mobile.** This document applies to users provisioned by Cobo Sales whose accounts were originally bound to Cobo Portal Mobile. If your account is bound to Cobo Guard, this document does not apply to you. Cobo Guard users who change devices or reinstall should follow the Cobo Guard reset procedure instead and wait for the official Portal Mobile migration path. See [Migrate from Cobo Guard](/en/portal-mobile/migrate-from-guard).</Note>
