...
<Note>Due to Solana on-chain mechanism, for Solana-chain transactions, the Cobo-side workflow (Spender approval, risk control approval, and MPC signing) must be completed within 1 minute. Otherwise, the Solana message signature will expire.</Note>
